...
public class Palindrome {
	...
	/*
	 * Manacher’s algorithm optimizes the “Expand Around The Centre” solution by
	 * using some insights into how palindromes work.
	 * 
	 * Let C be the center of the longest-length palindrome we have encountered till
	 * now. And let L and R be the left and right boundaries of this palindrome,
	 * i.e., the left-most character index and the right-most character index,
	 * respectively.
	 */
